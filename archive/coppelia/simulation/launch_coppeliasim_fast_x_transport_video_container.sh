...
INNER_SCRIPT="${ROOT}/outputs/control_runs/_coppelia_fast_x_video_container_inner.sh"
...
export VIDEO_NAME=${VIDEO_NAME:-coppelia_fast_x_transport.mp4}
export FPS=${FPS:-25}
cd ${ROOT}
exec bash simulation/launch_coppeliasim_fast_x_transport_video.sh "\$@"
EOF
