...
FRAME_DIR="${ROOT}/outputs/control_runs/coppelia_mujoco_like_x_sweep_frames"
STATE_DIR="${ROOT}/outputs/control_runs/coppelia_mujoco_like_x_sweep_state"
SIM_LOG="${STATE_DIR}/coppelia.log"
BOOT_LOG="${STATE_DIR}/bootstrap.log"
VIDEO_PATH="${ROOT}/demonstration_videos/ur5e_coppeliasim/coppeliasim_ur5_mujoco_like_x_sweep.mp4"
SUMMARY_PATH="${STATE_DIR}/coppeliasim_ur5_mujoco_like_x_sweep_summary.json"
ADDON_SOURCE="${ROOT}/simulation/ur5_origin_acquisition_video_addon.lua"
ADDON_TARGET="${COPPELIA_ROOT}/addOns/ur5_mujoco_like_x_sweep_video_addon.lua"
...
START_MARKER="${STATE_DIR}/ur5_mujoco_like_x_sweep_addon_started.txt"
LOAD_MARKER="${STATE_DIR}/ur5_mujoco_like_x_sweep_addon_loaded.txt"
SENSING_MARKER="${STATE_DIR}/ur5_mujoco_like_x_sweep_addon_sensing.txt"
DONE_MARKER="${STATE_DIR}/ur5_mujoco_like_x_sweep_done.txt"
FPS="${FPS:-15}"
